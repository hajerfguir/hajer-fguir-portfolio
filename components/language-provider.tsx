      ...
      items: {
        uottawa_it: {
          ...
          description: [
            ...
            "Supported SSDLC security initiatives by improving secure testing practices, validating security requirements, and contributing to QA documentation.",
            "Collaborated with developers, QA analysts, and stakeholders to resolve issues, validate system behavior, and improve application reliability.",
          ],
        },
        uottawa: {
          ...
          location: "Ottawa, ON, Canada",
          description: [
            "Executed load tests and API validation for the Experiential Learning platform.",
            "Developed automation scripts and JSON output validations to support data integrity and reliable backend integrations.",
            "Built and maintained RESTful APIs using JavaScript, Node.js, Docker, Redis, and CI/CD workflows.",
            "Performed end-to-end validations and performance testing to support high-volume user traffic and ensure system reliability.",
          ],
        },
        uottawa_faculty: {
          ...
          location: "Ottawa, ON, Canada",
          description: [
            "Supported undergraduate students in ITI1520 and SEG2911 through labs, feedback, and academic mentoring.",
            "Graded assignments and provided detailed feedback to help students improve technical and problem-solving skills.",
            "Ran lab sessions and offered one-on-one programming support in Python, software engineering concepts, and foundational computing topics.",
            "Strengthened communication, mentorship, and leadership skills while working with diverse student backgrounds.",
          ],
        },
        novasoft: {
    ...
    experience: {
      ...
      items: {
        uottawa_it: {
          ...
          location: "Ottawa, ON, Canada",
          description: [
            "Réaliser des tests fonctionnels, de régression, de charge, de bout en bout et de sécurité pour les plateformes universitaires, y compris uoZone et Experiential Learning.",
            "Développer des scénarios de tests d'authentification et de sécurité pour les flux SAML2/SSO, y compris la gestion des sessions, la validation des jetons et les scénarios d'authentification à forte charge.",
            "Soutenir les initiatives SSDLC en améliorant les pratiques de tests sécurisés, en validant les exigences de sécurité et en contribuant à la documentation d'assurance qualité.",
            "Collaborer avec des développeurs, des analystes QA et des parties prenantes pour résoudre les problèmes, valider le comportement du système et améliorer la fiabilité des applications.",
          ],
        },
        uottawa: {
          ...
          location: "Ottawa, ON, Canada",
          description: [
            "Exécuter des tests de charge et des validations d'API pour la plateforme Experiential Learning.",
            "Développer des scripts d'automatisation et des validations de sortie JSON pour soutenir l'intégrité des données et des intégrations backend fiables.",
            "Développer et maintenir des APIs RESTful en JavaScript, Node.js, Docker, Redis et workflows CI/CD.",
            "Réaliser des validations de bout en bout et des tests de performance pour supporter un trafic utilisateur à volume élevé et assurer la fiabilité du système.",
          ],
        },
        uottawa_faculty: {
          ...
          location: "Ottawa, ON, Canada",
          description: [
            "Soutenir les étudiants de premier cycle dans ITI1520 et SEG2911 via des labs, des retours et un encadrement académique.",
            "Corriger les travaux et fournir des retours détaillés pour aider les étudiants à améliorer leurs compétences techniques et de résolution de problèmes.",
            "Animer des séances de laboratoire et soutenir individuellement la programmation Python, les concepts de génie logiciel et les notions informatiques fondamentales.",
            "Renforcer les compétences en communication, mentorat et leadership en travaillant avec des étudiants de profils variés.",
          ],
        },
        novasoft: {
          ...
          location: "Laval, QC, Canada",
          description: [
            "Co-fonder une start-up technologique centrée sur la création de solutions logicielles et l'exploration de produits numériques innovants.",
            "Développer des outils sécurisés de traitement et de validation des données en Python et AVL Concerto.",
            "Définir les exigences techniques et contribuer au développement full-stack en appliquant des pratiques de codage sécurisées.",
            "Travailler transversalement sur les aspects techniques, produit et entrepreneuriaux, en renforçant l'autonomie, l'adaptabilité et la résolution de problèmes.",
          ],
        },
        dana_tm4: {
          ...
          location: "Boucherville, QC, Canada",
          description: [
            "Soutenir les activités de vérification et validation en contribuant aux outils internes, workflows d'automatisation et rapports axés sur les données.",
            "Développer des solutions Python pour soutenir les processus de vérification et améliorer l'accès aux informations liées aux tests.",
            "Créer des outils web internes en JavaScript pour standardiser les sorties de bases de données et améliorer la visibilité technique.",
            "Contribuer aux flux de données sécurisés et aux intégrations d'authentification, y compris SAML2 SSO avec Microsoft Azure AD.",
          ],
        },
        canada_post: {
          ...
          location: "Ottawa, ON, Canada",
          description: [
            "Créer des scripts d'automatisation en Python et des workflows d'analyse de données pour soutenir la surveillance de la performance opérationnelle.",
            "Travailler avec Power BI et des bases de données internes pour transformer des données techniques et opérationnelles en insights utiles.",
            "Soutenir l'analyse des KPI, l'amélioration des rapports et la prise de décision basée sur les données dans un environnement d'entreprise.",
            "Acquérir de l'expérience en collaborant avec des parties prenantes métier, des systèmes techniques et des données à grande échelle.",
          ],
        },
      },
    },
